...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-DonkeyKongJunior_MiSTer.git"
CORE_NAME=(Arcade-DonkeyKongJunior)
...
UPSTREAM_CORE_NAME=(Arcade-DonkeyKongJunior)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-DonkeyKongJunior.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-DonkeyKongJunior.rbf)
